  ...
  return (
    <div className="mt-24 mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        <h2 className="text-3xl sm:text-5xl leading-9 font-extrabold text-[#00205b]">About Us</h2>
        <h2 className="text-lg sm:text-2xl tracking-wide py-4 font-bold text-[#F9423A]">Thank you for wanting to learn more about IRS-Freshstart.org</h2>
